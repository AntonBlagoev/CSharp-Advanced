...
namespace StreetRacing
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            //Add car
            race.Add(car);
            Console.WriteLine("----------- Add car with the same plate ------------------");
            //Initialize Car
            Car car22 = new Car("BMW", "320ci", "NFS2005", 150, 1450);
            race.Add(car22);
            Console.WriteLine("----------- End add car with the same plate ------------------");
            //Remove car
            ...
            Console.WriteLine("----------- Count of Cars ------------------");
